...
const About = () => {
  return (
    <>
      <SEO title="Our Heritage & Philosophy | Earthora" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4 text-stone-700 text-sm leading-relaxed font-light">
            ...
            <p>
              Founded with the vision to create non-toxic, potent skincare solutions, Earthora source wild Kashmiri Saffron, organic Bhringraj, and Mysore Sandalwood directly from sustainable fair-trade farmers.
            </p>
            <p>
